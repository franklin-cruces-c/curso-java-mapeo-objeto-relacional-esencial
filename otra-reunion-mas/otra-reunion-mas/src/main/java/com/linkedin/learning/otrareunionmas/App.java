...
public class App {
	public static void main(String[] args) {
		...
		Reunion r1 = new Reunion(LocalDateTime.now().plusHours(2), "Otra Reunión de Test");
		Reunion r2 = new Reunion(LocalDateTime.now().plusDays(2), "Reunión de pasado mañana");
		Reunion r3 = new Reunion(LocalDateTime.now().plusDays(1), "Reunión de mañana");
		Reunion r4 = new Reunion(LocalDateTime.now().minusDays(1), "Reunión de ayer");
		...
		List<Reunion> reunionesManyana = reunionDao.reunionesManhana();
